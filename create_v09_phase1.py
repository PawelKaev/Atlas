...
with open('grammalang-core/tests/reflexive/phase1_tests.rs', 'w', encoding='utf-8') as f:
    f.write(tests)
...
print("\nAll v0.9 Phase 1 files created!")
