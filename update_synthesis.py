...
# Обновляем text_analysis.js с автоматическим синтезом
text_analysis_js = '''// Atlas IDE - Загрузка текста и анализ с автоматическим синтезом
...
print("text_analysis.js updated with auto-synthesis")

# 2. Добавляем CSS для синтезов
synthesis_css = '''
.synthesize-btn {
    width: 100%;
    padding: 8px;
...
with open('ide/frontend/css/synthesis.css', 'w', encoding='utf-8') as f:
    f.write(synthesis_css)
print("synthesis.css created")
